...
有兴趣一起完善翻译的话，可以到 https://github.com/ShinyGroup/SCTranslationData 查看详情。
...
以下内容是关于剧情翻译功能的简要说明，你可以使用插件来提取剧情文本，或使用预览功能把自己的翻译录成视频。
...
完成翻译后如果想让其他使用插件的人看到你的翻译，请到 https://github.com/ShinyGroup/SCTranslationData 查看详情。
